...
const STOP_WORDS = new Set([
  ...
  "바꾸는", "발생", "발생하", "배경", "보는", "본질", "사례", "사회초년생", "사항", "상황", "새로운", "생각하기", "설계",
  "성공적인", "스마트한", "시작", "실거래",
  "실제", "실체", "실천", "안전한", "알아보는", "완성", "완전", "왜", "요소", "위한", "유형", "의미", "이끄는",
  "이란", "이유", "이해", "이해하기", "익히기", "있는", "적용", "원리", "정복", "정리", "정의", "정확히", "조건", "좋은",
  "주요", "주의사항", "주의점", "줄이기", "중요성", "지역별", "지침", "진실", "진짜", "차이", "체크", "체크리스트", "콘텐츠", "따져보", "평가", "함정", "행동",
...
const PARTICLE_SUFFIXES = [
  "으로부터", "에서부터", "직장에서의", "이라고", "이라는", "에서는", "으로는", "에서의", "하는", "해야", "하기", "적인",
