...
마지막으로 권한이 있는 Cloudflare 계정에서 확인한 스냅샷은 2026-06-29 원격 D1 `wrangler d1 info`와 검수 쿼리 결과다. 2026-07-09 현재 로컬에서는 원격 D1 조회 권한 오류가 발생해, 아래 값은 최신 대시보드 수치가 아니라 마지막 확인값이다.
