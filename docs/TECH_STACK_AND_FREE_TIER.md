...
| 항목 | 현재 값 | 무료 한도 대비 |
|---|---:|---:|
| D1 크기 | 548KB | 5GB의 약 0.011% 미만 |
| 최근 24시간 rows read | 8,463 | 5,000,000의 약 0.17% |
| 최근 24시간 rows written | 368 | 100,000의 약 0.37% |
| 콘텐츠 / 퀴즈 | 100 / 100 | 매우 작음 |
| 공개 / 검수 대기 콘텐츠 | 45 / 55 | 출처 없는 기존 AI 상식 43개와 주제 부적합 12개를 숨김 보존 |
