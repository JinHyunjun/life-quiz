...
- RSS, YouTube 메타데이터, data.go.kr, 위키백과 원문 기반 AI 상식 수집 Cron
...
Service Binding의 대상이 먼저 존재해야 하므로 수집 Worker를 앱보다 먼저 배포합니다. 배치 수집은 KST 00시, 06시, 12시, 18시에 실행됩니다. Cloudflare Cron은 UTC 기준이므로 설정에는 `0 15`, `0 21`, `0 3`, `0 9`가 등록됩니다. 각 배치는 서울 자치구 하나를 순환하고, 매일 금융·주식 투자·부동산 기초 용어와 외부 문서로 근거를 확인한 일반 상식을 추가합니다.
